...
#ifndef _aspect_initial_composition_lithosphere_porosity_h
#define _aspect_initial_composition_lithosphere_porosity_h
...
namespace aspect
{
  namespace InitialComposition
  {
     ...
     */
    template <int dim>
    class LithospherePorosity : public Interface<dim>,
